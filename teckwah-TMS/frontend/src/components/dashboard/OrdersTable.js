...
import { Table, Badge, Tag, Button, Space, Tooltip, Typography, message } from 'antd';
import { CopyOutlined, EyeOutlined } from '@ant-design/icons';
import { formatDate, getStatusInfo, getDepartmentLabel, getWarehouseLabel, getTypeLabel } from '../../utils/helpers';
 ...
 */
const OrdersTable = ({ data, loading, onRowClick, onSelectionChange, pagination }) => {
