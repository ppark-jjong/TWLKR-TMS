...
class Dashboard(Base):
    ...
    status = Column(Enum("WAITING", "IN_PROGRESS", "COMPLETE", "ISSUE", "CANCEL", name="status_enum"), 
                   nullable=False, default="WAITING")
    department = Column(Enum("CS", "HES", "LENOVO", name="department_enum"), nullable=False, index=True)
    warehouse = Column(Enum("SEOUL", "BUSAN", "GWANGJU", "DAEJEON", name="warehouse_enum"), nullable=False)
