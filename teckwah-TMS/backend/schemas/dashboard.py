...
class DashboardBase(BaseModel):
    ...
    postal_code: str = Field(..., alias="postalCode", min_length=4, max_length=5, description="우편번호")
...
class DashboardCreate(DashboardBase):
    ...
    driver_name: Optional[str] = Field(None, alias="driverName", description="기사 이름")
    driver_contact: Optional[str] = Field(None, alias="driverContact", description="기사 연락처")
...
class DashboardUpdate(BaseModel):
    ...
    postal_code: Optional[str] = Field(None, alias="postalCode", min_length=4, max_length=5, description="우편번호")
...
class LockedInfo(BaseModel):
    """락 정보 스키마"""
    locked_by: Optional[str] = Field(None, alias="lockedBy", description="락 보유 사용자")
    locked_at: Optional[datetime] = Field(None, alias="lockedAt", description="락 획득 시간")
...
class DashboardResponse(DashboardBase):
    ...
    depart_time: Optional[datetime] = Field(None, alias="departTime", description="출발 시간")
    complete_time: Optional[datetime] = Field(None, alias="completeTime", description="완료 시간")
    ...
    duration_time: Optional[int] = Field(None, alias="durationTime", description="소요 시간(분)")
    driver_name: Optional[str] = Field(None, alias="driverName", description="기사 이름")
    driver_contact: Optional[str] = Field(None, alias="driverContact", description="기사 연락처")
    updated_by: Optional[str] = Field(None, alias="updatedBy", description="최종 수정자")
    remark: Optional[str] = Field(None, description="비고")
    update_at: Optional[datetime] = Field(None, alias="updateAt", description="최종 수정 시간")
    locked_info: Optional[LockedInfo] = Field(None, alias="lockedInfo", description="락 정보")
...
class DashboardFilter(BaseModel):
    """대시보드 필터 스키마"""
    start_date: Optional[datetime] = Field(None, alias="startDate", description="시작 날짜")
...
class DashboardListData(PaginatedResponse):
    ...
    status_counts: StatusCount = Field(..., alias="statusCounts", description="상태별 카운트")
...
class LockResponse(BaseModel):
    ...
    lock_status: Optional[LockStatus] = Field(None, alias="lockStatus", description="락 상태")
