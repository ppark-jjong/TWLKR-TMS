...
from main.dash.layouts.dashboard_layout import create_field_feedback_ui
                                                                ...
                                                                [
                                                                    dbc.Row(
                                                                        [
                                                                            ...
                                                                            dbc.Col(
                                                                                f"{dashboard_data.get('distance', 0)} km",
                                                                                width=8,
                                                                            ),
                                                                        ],
                                                                        className="mb-2",
                                                                    ...
                                                                    dbc.Row(
                                                                        [
                                                                            ...
                                                                            dbc.Col(
                                                                                f"{dashboard_data.get('duration_time', 0)} 분",
                                                                                width=8,
                                                                            ),
                                                                        ],
                                                                        className="mb-2",
                                        ...
                                        [
                                            ...
                                            html.Div(
                                                [
                                                    ...
                                                    dbc.Button(
                                                        "이슈",
                                                        id="status-issue-button",
                                                        color="danger",
                                                        className="me-2 mb-2",
                                                        disabled=is_locked
                                                        or current_status == "ISSUE",
                                                    ),
                                                    dbc.Button(
                                                        "취소",
                                                        id="status-cancel-button",
                                                        color="secondary",
                                                        className="me-2 mb-2",
                                                        disabled=is_locked
                                                        or current_status == "CANCEL",
                                                    ),
                                                ],
                                                className="mb-3",
                                            ),
        ...
        [
            ...
            dbc.ModalFooter(
                [
                    ...
                    dbc.Button(
                        "배차 완료", id="confirm-assign-button", color="primary"
                    ),
                ]
            ),
        ],
        ...
        [
            ...
            dbc.ModalFooter(
                [
                    dbc.Button(
                        "취소",
                        id="cancel-new-dashboard-button",
                        color="secondary",
                        className="me-2",
                    ),
                    dbc.Button(
                        "등록", id="confirm-new-dashboard-button", color="success"
                    ),
                ]
            ),
        ],
