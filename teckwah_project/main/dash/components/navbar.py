            ...
            [
                ...
                html.A(
                    dbc.Row(
                        [
                            ...
                            dbc.Col(dbc.NavbarBrand("배송 실시간 관제 시스템", className="ms-2")),
                        ],
                        align="center",
                        className="g-0",
                    ),
                ...
                dbc.Collapse(
                    dbc.Nav(
                        [
                            # 기본 메뉴 아이템
                            dbc.NavItem(dbc.NavLink("대시보드", href="/dashboard", className="px-3")),
                            dbc.NavItem(dbc.NavLink("시각화", href="/visualization", className="px-3")),
