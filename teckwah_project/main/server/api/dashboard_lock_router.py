...
from main.server.schemas.dashboard_schema import LockRequest
...
from main.server.services.dashboard_lock_service import DashboardLockService
from main.server.api.deps import get_dashboard_lock_service
